            ...
            <dl className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8">
              <div className="pt-4">
                ...
                <dd className="mt-2 text-lg text-white">
                  ...
                  Each path has its challenges, rewards, and lore. Your
                  adventure begins now!
                </dd>
              </div>
              <div className="pt-4">
                <dt className="flex gap-2 font-semibold lg:text-3xl min-[320px]:text-2xl text-white">
                  <Image src={icon2} alt="Paladin" />
                  Quest
                </dt>
                <dd className="mt-2 text-lg text-white">
                  Answer destiny&apos;s call and embark on an epic quest. Your
                  choices will shape your journey, carving a path to glory or
                  ruin in this vast world.
                </dd>
              </div>
              <div className="pt-4">
                <dt className="flex gap-2 font-semibold lg:text-3xl min-[320px]:text-2xl text-white">
                  <Image src={icon3} alt="Paladin" />
                  Arena
                </dt>
                <dd className="mt-2 text-lg text-white">
                  Step into the arena, where bravery is measured and legends are
                  born. Will your sword sway the balance of victory or defeat?
                </dd>
              </div>
              <div className="pt-4">
                <dt className="flex gap-2 font-semibold lg:text-3xl min-[320px]:text-2xl text-white">
                  <Image src={icon4} alt="Paladin" />
                  Training
                </dt>
                <dd className="mt-2 text-lg text-white">
                  Hone your skills through rigorous training, for it&apos;s the
                  key to survival. As you grow stronger, so does your legend in
                  this epic tale.
                </dd>
              </div>
              <div className="pt-4">
                <dt className="flex gap-2 font-semibold lg:text-3xl min-[320px]:text-2xl text-white">
                  <Image src={icon5} alt="Paladin" />
                  Craft
                </dt>
                <dd className="mt-2 text-lg text-white">
                  Forge weapons and armor that could turn the tides of battle.
                  Your craftsmanship will be your edge in the heart of conflict.
                </dd>
              </div>
            </dl>
          </div>
