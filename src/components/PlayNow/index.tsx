      ...
      <div className="flex flex-col gap-10 items-start px-16 xl:px-52 pt-56 pb-40">
        ...
        <div className="max-w-[493px] py-2 border-t border-white">
          <p className="font-light">
            Welcome to Omni Kingdoms, a medieval land where danger and wonder 
            intertwine. Here, every choice you make shapes your destiny in this 
            grand tale of swords and sorcery.
          </p>
        </div>
